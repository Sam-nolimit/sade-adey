...
const products = [
  {
    ...
    quantity: 2,
    imageSrc:
      "https://tommybahama.scene7.com/is/image/TommyBahama/ST326336_11438_main?$main_detail_500$",
    imageAlt: "image 1",
  },
  {
    id: 2,
    ...
    quantity: 1,
    imageSrc:
      "https://tommybahama.scene7.com/is/image/TommyBahama/BR34723BLWG_1055_main?$main_detail_500$",
    imageAlt: "image 2",
  },
  {
    id: 3,
    ...
    quantity: 2,
    imageSrc:
      "https://tommybahama.scene7.com/is/image/TommyBahama/T220856_19393_main?$main_detail_500$",
    imageAlt: "image 3",
  },
  {
    id: 4,
    ...
    quantity: 1,
    imageSrc:
      "https://tommybahama.scene7.com/is/image/TommyBahama/ST889700_2939_main?$main_detail_500$",
    imageAlt: "image 4",
  },
  {
    id: 5,
        ...
        >
          ...
          >
            ...
            <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
              <div className="flex h-full flex-col overflow-y-scroll bg-white rounded-3xl">
                          ...
                          <div className="ml-4 flex flex-1 flex-col">
                            ...
                            <div className="flex flex-1 items-end justify-between text-sm">
                              ...
                              <div className="flex">
                                <button
                                  type="button"
                                  className="font-normal text-gray-800 hover:underline"
                                >
                                  Remove
                                </button>
                              </div>
                ...
                >
                  ...
                  <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                    <p>
                      ...
                      <button
                        type="button"
                        className="font-medium text-gray-600 hover:text-transparent bg-clip-text bg-gradient-to-l from-gray-500 to-gray-500 ml-1"
                        onClick={() => setOpen(false)}
                      >
