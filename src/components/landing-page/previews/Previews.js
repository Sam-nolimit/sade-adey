    ...
    <div className="bg-gray-100">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex">
            <motion.h2
              className="text-2xl font-bold text-gray-900 mr-1.5"
              variants={textMotion}
            >
              Explore
            </motion.h2>
            <motion.h2
              className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-l from-gray-800 to-gray-900 mr-1.5"
              variants={textMotion}
            >
              Trending
            </motion.h2>
          ...
          <div className="mt-6 space-y-12 lg:grid sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-6 lg:space-y-0">
            {callouts.map((callout) => (
              <div key={callout.name} className="group relative">
                {/* Collection Image */}
                <motion.div
                  className="relative h-80 w-full overflow-hidden rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 shadow-xl transition-transform duration-300 transform group-hover:scale-95 sm:h-64"
                ...
                <motion.span variants={textMotion}>
                  {/* Collection Title */}
                  <h3 className="mt-6 text-1xl font-none text-gray-600">
