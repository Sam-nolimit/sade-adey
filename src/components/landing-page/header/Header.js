        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          ...
          <motion.div className="mt-10"
            ...
            <motion.span variants={textMotion}>
              <Link to="/new-arrivals/" className="inline-block rounded-full border border-transparent bg-gray-900 px-4 lg:px-8 py-2 lg:py-3 text-center font-medium text-white transition-transform duration-300 transform hover:scale-95 hover:bg-gradient-to-l from-gray-500 to-gray-500 shadow-lg">
                Explore Collection
              </Link>
            </motion.span>
