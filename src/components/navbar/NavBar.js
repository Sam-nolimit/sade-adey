            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                >
                  <button
                    type="button"
                    className="-m-2 inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:text-gray-600"
                        ...
                        >
                          {category.featured.map((item) => (
                            ...
                            >
                              ...
                              <Link
                                to={item.href}
                                className="mt-6 block font-semibold text-gray-900 hover:text-gray-600"
                              >
                              ...
                              >
                                {section.items.map((item) => (
                                  <li key={item.name} className="flow-root">
                                    <Link
                                      to={item.href}
                                      className="-m-2 block p-2 text-gray-500 hover:text-gray-600"
                                    >
                                      {item.name}
                                    </Link>
                                  </li>
                ...
                >
                  ...
                  >
                    <img
                      src={
                        "https://shorturl.at/kCIS3"
                      }
                      alt="Nigeria"
                      className="block h-auto w-5 flex-shrink-0"
                    />
                    <span className="ml-3 block text-sm font-medium hover:text-gray-600 hover:font-semibold">
                      NGN
                    </span>
                  </Link>
                </motion.div>
          ...
          >
            <div className="flex h-16 items-center">
              ...
              <motion.button
                variants={textMotion}
                type="button"
                className="rounded-md bg-white p-2 text-gray-400 hover:text-gray-600 lg:hidden"
                                    ...
                                    <div className="col-start-2 grid grid-cols-2 gap-x-8">
                                      {category.featured.map((item) => (
                                        ...
                                        >
                                          ...
                                          <Link
                                            to={item.href}
                                            className="mt-6 block font-medium text-gray-900 hover:text-gray-600"
                                          >
                                            <span
